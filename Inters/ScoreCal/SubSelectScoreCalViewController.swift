//
//  subjectSelectionScoreCalViewController.swift
//  Inters
//
...
class SubSelectScoreCalViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    static let vc1 = SubSelectScoreCalViewController()
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = subjectTableView.dequeueReusableCell(withIdentifier: "subjectCell") as! subjectCell
        ...
        //let resizedImg = subjectsImg[indexPath.row]?.resizedImage(Size: CGSize(width: 200, height: 200))
        //cell.subjectImgView.image = resizedImg
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        SubSelectScoreCalViewController.vc1.selectedSubjectLabel = subjects[indexPath.row]
           
           self.performSegue(withIdentifier: "toInsideScoreCal", sender: self)
