...
class ChecklistViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = subjectTableView.dequeueReusableCell(withIdentifier: "subjectChecklistCell") as! subjectCellChecklist
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
           ...
           ChecklistViewController.vc1.selectedSubjectLabel = subjects[indexPath.row]
           ChecklistViewController.vc1.selectedImg = subjectsImg[indexPath.row]
           self.performSegue(withIdentifier: "goInsideChecklist", sender: self)
...
class subjectCellChecklist:UITableViewCell{
